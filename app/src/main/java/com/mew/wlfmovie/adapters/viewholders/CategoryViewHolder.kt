...
import com.mew.wlfmovie.models.Show
...
class CategoryViewHolder(
    ...
    private fun displayMobileItem(
        ...
        binding.rvCategory.apply {
            ...
            // WLFMOVIE: Salvaguarda para scroll infinito.
            // Guardar el estado del LayoutManager antes de submitList y
            // restaurarlo después. Así, si el RV interno se recicla o se
            // rebind, el scroll del carrusel se mantiene en su posición.
            ...
            // WLFMOVIE: Restaurar estado de scroll
            savedState?.let { state -> layoutManager?.onRestoreInstanceState(state) }

            // WLFMOVIE: Scroll infinito - cargar más cuando llegue al final
            if (category.onLoadMore != null) {
    ...
    private fun displayTvItem(
        ...
        binding.hgvCategory.apply {
            ...
            // WLFMOVIE: Salvaguarda para scroll infinito en TV.
            val savedState = layoutManager?.onSaveInstanceState()
