package com.mew.wlfmovie.fragments.player.settings
...
import com.mew.wlfmovie.utils.mediaServers
import com.mew.wlfmovie.utils.SubDL
import com.mew.wlfmovie.utils.UserPreferences
import com.mew.wlfmovie.utils.dp
import com.mew.wlfmovie.utils.findClosest
import com.mew.wlfmovie.utils.getAlpha
import com.mew.wlfmovie.utils.getRgb
import com.mew.wlfmovie.utils.mediaServerId
import com.mew.wlfmovie.utils.setAlpha
import com.mew.wlfmovie.utils.setRgb
import com.mew.wlfmovie.utils.supportedTrackFormats
        ...
        sealed class Subtitle : Item {
            ...
            sealed class OpenSubtitles : Item {
                ...
                companion object : Settings.Subtitle() {
                    ...
                    fun init(openSubtitles: List<com.mew.wlfmovie.utils.OpenSubtitles.Subtitle>) {
                        list.clear()
                ...
                class Subtitle(
                    val openSubtitle: com.mew.wlfmovie.utils.OpenSubtitles.Subtitle
                ) : OpenSubtitles()
            }
            ...
            sealed class SubDLSubtitles : Item {
                ...
                companion object : Settings.Subtitle() {
                    ...
                    fun init(subDLSubtitles: List<com.mew.wlfmovie.utils.SubDL.Subtitle>) {
                        list.clear()
                ...
                class Subtitle(
                    val subDLSubtitle: com.mew.wlfmovie.utils.SubDL.Subtitle
                ) : SubDLSubtitles()
            }
        }
