...
import com.mew.wlfmovie.databinding.ItemSettingMobileBinding
import com.mew.wlfmovie.databinding.ViewPlayerSettingsMobileBinding
import com.mew.wlfmovie.utils.dp
import com.mew.wlfmovie.utils.margin
                ...
                setOnClickListener {
                    when (item) {
                        ...
                        is Settings.Gestures -> {
                            when (item) {
                                is Settings.Gestures.On -> com.mew.wlfmovie.utils.UserPreferences.playerGestures = true
                                is Settings.Gestures.Off -> com.mew.wlfmovie.utils.UserPreferences.playerGestures = false
                            }
                            settingsView.displaySettings(Setting.MAIN)
                        }
                        ...
                        is Settings.KeepScreenOn -> {
                            when (item) {
                                is Settings.KeepScreenOn.On -> com.mew.wlfmovie.utils.UserPreferences.keepScreenOnWhenPaused = true
                                is Settings.KeepScreenOn.Off -> com.mew.wlfmovie.utils.UserPreferences.keepScreenOnWhenPaused = false
                            }
                            settingsView.displaySettings(Setting.MAIN)
                        }
